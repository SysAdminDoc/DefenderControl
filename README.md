...
![Version](https://img.shields.io/badge/Version-v3.3.2-informational)
...
The build cleans `dist\`, creates `dist\DefenderControl-v3.3.2.zip` containing `DefenderControl.ps1`, `README.md`, and `LICENSE`, then writes release checksums to `dist\SHA256SUMS.txt`.
